...
export const generate = action({
  ...
  handler: async (_ctx, args) => {
    ...
    const userContent =
      ...
      `${args.sampleData ? args.sampleData + "\n\n" : ""}` +
      `Create a highlight zone for: ${args.description}`;
